...
class CreateGalleryAdapter(val sliderImage: ArrayList<String>, val context: Context, val deleteImageListener: DeleteImageListener, val vm: MainViewModelForTeacher): RecyclerView.Adapter<CreateGalleryAdapter.TaskHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.create_gallery_item, parent, false)
    ...
    override fun onBindViewHolder(holder: TaskHolder, position: Int) {
        ...
        if (sliderImage.size > position){
            ...
            holder.deleteImage.setOnClickListener {
                deleteImageListener.deleteImage(holder.position)
            }
        }
    }
